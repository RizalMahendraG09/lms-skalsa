...
<x-guest-layout>
    ...
    <div class="text-center mb-6">
        ...
        @endif
        <h2 class="text-xl font-bold text-base-content">Atur Ulang Password</h2>
        <p class="text-sm text-base-content/60 mt-1">Masukkan password baru Anda di bawah ini.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" x-data="{ loading: false }" @submit="loading = true">
        ...
        <div class="mt-6">
            <button type="submit" :disabled="loading" class="btn btn-primary w-full h-12 text-base font-semibold rounded-lg">
                <span x-show="!loading">Atur Ulang Password</span>
