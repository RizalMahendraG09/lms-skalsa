...
<head>
    ...
    <style>
   .hero-gradient {
    background: linear-gradient(135deg, rgba(30,58,95,0.82), rgba(45,90,135,0.82)), url('/images/hero-bg.jpeg');
    ...
    <div class="navbar bg-base-100 shadow-lg sticky top-0 z-50">
        ...
        <div class="navbar-center hidden lg:flex">
            <ul class="menu menu-horizontal px-1 gap-1">
                ...
                <li><a href="{{ route('pengumuman.index') }}" class="{{ request()->routeIs('pengumuman.*') ? 'active font-semibold' : '' }}">Pengumuman</a></li>
                <li><a href="{{ route('galeri.index') }}" class="{{ request()->routeIs('galeri.*') ? 'active font-semibold' : '' }}">Galeri</a></li>
