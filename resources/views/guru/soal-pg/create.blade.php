<x-app-layout>
    ...
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            <form action="{{ route('guru.tugas.soal-pg.store', $tugas) }}" method="POST">
                @csrf
                ...
                <div class="form-control mb-4">
                    ...
                    <textarea id="pertanyaan" name="pertanyaan" rows="3" class="textarea textarea-bordered" placeholder="Masukkan pertanyaan">{{ old('pertanyaan') }}</textarea>
                    @error('pertanyaan')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div class="form-control">
                        ...
                        <input type="text" id="opsi_a" name="opsi_a" value="{{ old('opsi_a') }}" class="input input-bordered" placeholder="Opsi A">
                        @error('opsi_a')
                            <span class="text-error text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-control">
                        ...
                        <input type="text" id="opsi_b" name="opsi_b" value="{{ old('opsi_b') }}" class="input input-bordered" placeholder="Opsi B">
                        @error('opsi_b')
                            <span class="text-error text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-control">
                        ...
                        <input type="text" id="opsi_c" name="opsi_c" value="{{ old('opsi_c') }}" class="input input-bordered" placeholder="Opsi C">
                        @error('opsi_c')
                            <span class="text-error text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-control">
                        ...
                        <input type="text" id="opsi_d" name="opsi_d" value="{{ old('opsi_d') }}" class="input input-bordered" placeholder="Opsi D">
                        @error('opsi_d')
                            <span class="text-error text-sm">{{ $message }}</span>
                        @enderror
                    </div>
