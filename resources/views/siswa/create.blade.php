        ...
        <div class="card-body">
            <form action="{{ route('admin.siswa.store') }}" method="POST">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="nis" class="input input-bordered" value="{{ old('nis') }}" placeholder="Nomor Induk Siswa">
                    @error('nis')
                ...
                <div class="form-control mt-4">
                    ...
                    <input type="text" name="name" class="input input-bordered" value="{{ old('name') }}" placeholder="Nama lengkap siswa">
                    @error('name')
                        <span class="text-error text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-control mt-4">
                    ...
                    <input type="email" name="email" class="input input-bordered" value="{{ old('email') }}" placeholder="siswa@skalsa.sch.id">
                    @error('email')
                        <span class="text-error text-sm">{{ $message }}</span>
                    @enderror
                </div>
